					...
					<div class="w3l-specilamk">
						...
						<div class="product-name-w3l">
							...
							<div class="w3l-pricehkj">
								...
								<p style="text-align: center; border: none"><button onclick="addCart(<?=$pro['ProductId']?>,1,<?=$pro['Price']?>,'<?=$pro['ProductName']?>','<?=$pro['Img']?>','<?=$pro['url']?>',<?=$pro['Point']?>,0)" class="btn btn-success">Thêm Vào Giỏ</button></p>
							</div>
							<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
